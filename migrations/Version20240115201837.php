 ...
 */
final class Version20240115201837 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE educateur_mail_edu (educateur_id INT NOT NULL, mail_edu_id INT NOT NULL, INDEX IDX_706D1A826BFC1A0E (educateur_id), INDEX IDX_706D1A829D911D20 (mail_edu_id), PRIMARY KEY(educateur_id, mail_edu_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE mail_contact (id INT AUTO_INCREMENT NOT NULL, date_envoi DATETIME NOT NULL, objet VARCHAR(255) NOT NULL, message LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE mail_edu (id INT AUTO_INCREMENT NOT NULL, date_envoi DATETIME NOT NULL, objet VARCHAR(255) NOT NULL, message LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE educateur_mail_edu ADD CONSTRAINT FK_706D1A826BFC1A0E FOREIGN KEY (educateur_id) REFERENCES educateur (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE educateur_mail_edu ADD CONSTRAINT FK_706D1A829D911D20 FOREIGN KEY (mail_edu_id) REFERENCES mail_edu (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE educateur_mail_edu DROP FOREIGN KEY FK_706D1A826BFC1A0E');
        $this->addSql('ALTER TABLE educateur_mail_edu DROP FOREIGN KEY FK_706D1A829D911D20');
        ...
        $this->addSql('DROP TABLE educateur_mail_edu');
